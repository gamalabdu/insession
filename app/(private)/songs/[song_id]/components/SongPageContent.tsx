...
const SongPageContent = (props: SongPageContentProps) => {
  ...
  <div className="w-full p-4">
    ...
    <div className="flex items-center align-middle gap-5">
      ...
      <Input placeholder="What do you think?" value={comment} onChange={(e) => setComment(e.target.value)} />
    ...
    <div className="text-neutral-500 flex items-center align-middle gap-3 mt-10"> {comments.length.toString()} Comments  <FaRegMessage /> </div>
            ...
            <div className="flex flex-col gap-4">
              {
                comments.map((comment, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex items-center align-middle gap-5 p-2 rounded-md bg-neutral-800">
                          <div className="aspect-square h-[40px] relative rounded-full bg-gray-200">
                            <Image
                          ...
                          <div className="text-sm text-neutral-600">{timeAgoString}</div>
                    </div>
                  )
                })
              }
